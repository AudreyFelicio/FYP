...
all: generator bruteforce best_input relative_order approx_median naive_local_search iterated_local_search tabu_search
...
tabu_search:
	$(CXX) $(CXXFLAGS) -o build/tabu_search tabu_search.cpp
